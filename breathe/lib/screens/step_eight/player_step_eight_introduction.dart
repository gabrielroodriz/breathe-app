...
class PlayerEightStepIntroduction extends StatefulWidget {
  @override
  _PlayerEightStepIntroductionState createState() =>
      _PlayerEightStepIntroductionState();
}

class _PlayerEightStepIntroductionState
    extends State<PlayerEightStepIntroduction> {
  bool playing = false;
                          ...
                          children: [
                            ...
                            IconButton(
                                ...
                                onPressed: () {
                                  if (!playing) {
                                    cache.load(
                                        "sounds/Introdução_ Equilibrando o jogo - 08.m4a");
                                    cache.play(
                                        "sounds/Introdução_ Equilibrando o jogo - 08.m4a");
                                    setState(() {
