...
class PlayerEightStepPractice extends StatefulWidget {
  @override
  _PlayerEightStepPracticeState createState() =>
      _PlayerEightStepPracticeState();
}

class _PlayerEightStepPracticeState extends State<PlayerEightStepPractice> {
  bool playing = false;
                          ...
                          children: [
                            ...
                            IconButton(
                                ...
                                onPressed: () {
                                  if (!playing) {
                                    cache.load(
                                        "sounds/Pratica_ Equilibrando o jogo - 08.m4a");
                                    cache.play(
                                        "sounds/Pratica_ Equilibrando o jogo - 08.m4a");
                                    setState(() {
