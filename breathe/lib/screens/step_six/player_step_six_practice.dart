...
class PlayerSixStepPractice extends StatefulWidget {
  @override
  _PlayerSixStepPracticeState createState() => _PlayerSixStepPracticeState();
}

class _PlayerSixStepPracticeState extends State<PlayerSixStepPractice> {
  bool playing = false;
