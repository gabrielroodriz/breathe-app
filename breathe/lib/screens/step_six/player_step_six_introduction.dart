...
class PlayerSixStepIntroduction extends StatefulWidget {
  @override
  _PlayerSixStepIntroductionState createState() =>
      _PlayerSixStepIntroductionState();
}

class _PlayerSixStepIntroductionState extends State<PlayerSixStepIntroduction> {
  bool playing = false;
                          ...
                          children: [
                            ...
                            IconButton(
                                ...
                                onPressed: () {
                                  if (!playing) {
                                    cache.load(
                                        "sounds/Introducao florescer - 06.m4a");
                                    cache.play(
                                        "sounds/Introducao florescer - 06.m4a");
                                    setState(() {
