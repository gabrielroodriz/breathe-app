...
import 'package:breathe/screens/step_six/player_step_six_introduction.dart';
import 'package:breathe/screens/step_six/player_step_six_practice.dart';
...
class DetailsScreenSixStep extends StatelessWidget {
  @override
          ...
          children: <Widget>[
            Container(
              ...
              decoration: BoxDecoration(
                color: Color(0xFFefea5a),
                image: DecorationImage(
                  image: AssetImage("assets/images/urban-line-289.png"),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      width: size.width * .6,
                      child: Text(
                        "Um exercício para termos maior clareza sobre nossas motivações.",
                        style: TextStyle(
                            fontWeight: FontWeight.bold, color: Colors.white),
                      ),
                    ),
                    ...
                    CardModule(
                      ...
                      srcScreen: PlayerSixStepIntroduction(),
                    ),
                    CardModule(
                      title: 'Prática: As quatro questões.',
                      description: 'Relaxando o corpo e a mente',
                      srcScreen: PlayerSixStepPractice(),
                    )
                  ],
                ),
              ),
