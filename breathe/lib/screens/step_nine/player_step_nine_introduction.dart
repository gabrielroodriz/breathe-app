...
class PlayerNineStepIntroduction extends StatefulWidget {
  @override
  _PlayerNineStepIntroductionState createState() =>
      _PlayerNineStepIntroductionState();
}

class _PlayerNineStepIntroductionState
    extends State<PlayerNineStepIntroduction> {
  bool playing = false;
