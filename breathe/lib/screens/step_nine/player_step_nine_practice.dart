...
class PlayerNineStepPractice extends StatefulWidget {
  @override
  _PlayerNineStepPracticeState createState() => _PlayerNineStepPracticeState();
}

class _PlayerNineStepPracticeState extends State<PlayerNineStepPractice> {
  bool playing = false;
                          ...
                          children: [
                            ...
                            IconButton(
                                ...
                                onPressed: () {
                                  if (!playing) {
                                    cache.load(
                                        "sounds/Pratica_ Estabelecendo a mente em seu estado natural -09.m4a");
                                    cache.play(
                                        "sounds/Pratica_ Estabelecendo a mente em seu estado natural -09.m4a");
                                    setState(() {
