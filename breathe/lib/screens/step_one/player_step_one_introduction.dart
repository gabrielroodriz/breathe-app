...
class PlayerFirstStepIntroduction extends StatefulWidget {
  @override
  _PlayerFirstStepIntroductionState createState() =>
      _PlayerFirstStepIntroductionState();
}

class _PlayerFirstStepIntroductionState
    extends State<PlayerFirstStepIntroduction> {
  bool playing = false;
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            IconButton(
                                ...
                                onPressed: () {
                                  if (!playing) {
                                    cache.load("sounds/Introdução.m4a");
                                    cache.play("sounds/Introdução.m4a");
                                    setState(() {
