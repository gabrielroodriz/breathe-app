...
class PlayerFourStepIntroduction extends StatefulWidget {
  @override
  _PlayerFourStepIntroductionState createState() =>
      _PlayerFourStepIntroductionState();
}

class _PlayerFourStepIntroductionState
    extends State<PlayerFourStepIntroduction> {
  bool playing = false;
                          ...
                          children: [
                            ...
                            IconButton(
                                ...
                                onPressed: () {
                                  if (!playing) {
                                    cache.load(
                                        "sounds/Introdução_ Refletindo sobre o telescópio.m4a");
                                    cache.play(
                                        "sounds/Introdução_ Refletindo sobre o telescópio.m4a");
                                    setState(() {
