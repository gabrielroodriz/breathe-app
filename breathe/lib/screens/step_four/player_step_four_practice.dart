...
class PlayerFourStepPractice extends StatefulWidget {
  @override
  _PlayerFourStepPracticeState createState() => _PlayerFourStepPracticeState();
}

class _PlayerFourStepPracticeState extends State<PlayerFourStepPractice> {
  bool playing = false;
