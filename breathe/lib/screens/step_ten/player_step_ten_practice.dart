...
class PlayerTenStepPractice extends StatefulWidget {
  @override
  _PlayerTenStepPracticeState createState() => _PlayerTenStepPracticeState();
}

class _PlayerTenStepPracticeState extends State<PlayerTenStepPractice> {
  bool playing = false;
