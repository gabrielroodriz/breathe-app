...
import 'package:breathe/screens/step_two/player_step_two_introduction.dart';
import 'package:breathe/screens/step_two/player_step_two_practice.dart';
...
class DetailsScreenSecondStep extends StatelessWidget {
  @override
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage("assets/images/fogg-619.png"),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      width: size.width * .6,
                      child: Text(
                        "Cultivando o relaxamento a partir de dentro.",
                        style: TextStyle(
                            fontWeight: FontWeight.bold, color: Colors.white),
                      ),
                    ),
                    ...
                    CardModule(
                      ...
                      srcScreen: PlayerTwoStepIntroduction(),
                    ),
                    CardModule(
                      title: 'Prática: Respiração profunda',
                      description: 'Relaxando o corpo e a mente',
                      srcScreen: PlayerTwoStepPractice(),
                    )
                  ],
                ),
              ),
