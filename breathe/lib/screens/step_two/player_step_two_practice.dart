...
class PlayerTwoStepPractice extends StatefulWidget {
  @override
  _PlayerTwoStepPracticeState createState() => _PlayerTwoStepPracticeState();
}

class _PlayerTwoStepPracticeState extends State<PlayerTwoStepPractice> {
  bool playing = false;
