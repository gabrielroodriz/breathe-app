...
class PlayerFiveStepIntroduction extends StatefulWidget {
  @override
  _PlayerFiveStepIntroductionState createState() =>
      _PlayerFiveStepIntroductionState();
}

class _PlayerFiveStepIntroductionState
    extends State<PlayerFiveStepIntroduction> {
  bool playing = false;
                          ...
                          children: [
                            ...
                            IconButton(
                                ...
                                onPressed: () {
                                  if (!playing) {
                                    cache.load(
                                        "sounds/Introducao consciencia metacognitiva - 05.m4a");
                                    cache.play(
                                        "sounds/Introducao consciencia metacognitiva - 05.m4a");
                                    setState(() {
