...
class DetailsScreenFiveStep extends StatelessWidget {
  @override
          ...
          children: <Widget>[
            Container(
              ...
              decoration: BoxDecoration(
                color: Color(0xFF83e377),
                image: DecorationImage(
                  image: AssetImage("assets/images/clip-1011.png"),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      width: size.width * .6,
                      child: Text(
                        "Uma incrível jornada para o conhecimento de nós mesmos.",
                        style: TextStyle(
                            fontWeight: FontWeight.bold, color: Colors.white),
                      ),
                    ),
                    ...
                    CardModule(
                      ...
                      srcScreen: PlayerFiveStepIntroduction(),
                    ),
                    CardModule(
                      title: 'Prática: Consciência aberta.',
                      description: 'Relaxando o corpo e a mente',
                      srcScreen: PlayerFiveStepPractice(),
                    )
                  ],
                ),
              ),
