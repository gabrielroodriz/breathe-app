...
class PlayerSevenStepPractice extends StatefulWidget {
  @override
  _PlayerSevenStepPracticeState createState() =>
      _PlayerSevenStepPracticeState();
}

class _PlayerSevenStepPracticeState extends State<PlayerSevenStepPractice> {
  bool playing = false;
                          ...
                          children: [
                            ...
                            IconButton(
                                ...
                                onPressed: () {
                                  if (!playing) {
                                    cache.load(
                                        "sounds/Pratica_ Expandindo a mente - 07.m4a");
                                    cache.play(
                                        "sounds/Pratica_ Expandindo a mente - 07.m4a");
                                    setState(() {
