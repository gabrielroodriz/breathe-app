...
class PlayerThreeStepIntroduction extends StatefulWidget {
  @override
  _PlayerThreeStepIntroductionState createState() =>
      _PlayerThreeStepIntroductionState();
}

class _PlayerThreeStepIntroductionState
    extends State<PlayerThreeStepIntroduction> {
  bool playing = false;
                          ...
                          children: [
                            ...
                            IconButton(
                                ...
                                onPressed: () {
                                  if (!playing) {
                                    cache.load(
                                        "sounds/Introdução - A Revolução da atenção - Passo 03.m4a");
                                    cache.play(
                                        "sounds/Introdução - A Revolução da atenção - Passo 03.m4a");
                                    setState(() {
