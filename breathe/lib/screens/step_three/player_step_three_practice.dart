...
class PlayerThreeStepPractice extends StatefulWidget {
  @override
  _PlayerThreeStepPracticeState createState() =>
      _PlayerThreeStepPracticeState();
}

class _PlayerThreeStepPracticeState extends State<PlayerThreeStepPractice> {
  bool playing = false;
                          ...
                          children: [
                            ...
                            IconButton(
                                ...
                                onPressed: () {
                                  if (!playing) {
                                    cache.load(
                                        "sounds/Prática_ atenção plena à respiração - 03.m4a");
                                    cache.play(
                                        "sounds/Prática_ atenção plena à respiração - 03.m4a");
                                    setState(() {
